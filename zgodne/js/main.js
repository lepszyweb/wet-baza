  ...
  if (audio) {
    ...
    buttonPlay.addEventListener("click", function () {
      ...
      if (playIcon.classList.contains("glyphicon-pause")) {
        buttonPlay.innerHTML = "Pauza <span id='playIcon' class='glyphicon glyphicon-pause' tabindex='-1' role='presentation'></span>";
        console.log(buttonPlay);
      } else if (playIcon.classList.contains("glyphicon-play")) {
        buttonPlay.innerHTML = "Graj <span id='playIcon' class='glyphicon glyphicon-play' tabindex='-1' role='presentation'></span>";
      }
